...
/**
 * Each fractal function is constructed from base functions or "unit functions"
 * at various scales (a little like wavelets) chosen from appropriate
 * probability distributions to preserve self-similarity. <p> The name <i>unit
 * function</i> comes from the fact that the non-zero portion of each function
 * is constrained to a unit hypercube, centred at the origin. In the 1-d case
 * this is therefore the interval (-0.5, 0.5). <p> This is the superclass of all
 * 1-d unit functions. If you are writing your own unit function you only need
 * to call the constructors from your own constructors using super(), and
 * provide an implementation for getValue(point).
 *
...
public abstract class UnitFunction1D {
    ...
    /**
     * Construct a default unit function whose centre and scale will be set
     * later - only called by subclasses.
     */
     ...
     *
     * @param centre the x-axis value to which the centre of this unitfunction
     * is mapped
     ...
     *
     * @return the x-axis value to which the centre of this unitfunction is
     * mapped
     */
