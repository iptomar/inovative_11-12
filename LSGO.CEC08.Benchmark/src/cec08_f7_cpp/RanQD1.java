...
/**
 * This class implements the (repeatable) "quick and dirty" portable
 * pseudo-random generator with modulus 2<sup>32</sup> in W. H. Press et al,
 * "Numerical Recipes in C: The Art of Scientific Computing", Cambridge
 * University Press, 2nd Ed., 1992, with values recommended by Knuth. It is the
 * fastest generator recommended in the above tome. <p> The original relies on
 * the fact that in C on a 32-bit machine, multiplying two unsigned long ints
 * returns the lower 32 bits of the 64 bit product. Since we are using Java (no
 * unsigned ints) and a 64-bit architecture, we mimic this using 64 bit longs
 * with bit-masking instead.
 *
