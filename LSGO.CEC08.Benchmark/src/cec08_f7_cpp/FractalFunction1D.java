...
/**
 * This class is called by {@link FastFractal} to evaluate the components for
 * each dimension to evaluate fast very high-dimensional fractal functions
 * (landscapes). <p> It can also be used directly to generate 1-dimensional
 * fractal landscapes.
 *
...
public class FractalFunction1D {
     ...
     * 2^64 although in practice maximum supported by IEEE 64-bit floating point
    ...
    /**
     * Create a new generator in the same series by resetting the index (faster
    ...
    public double evaluate(double x) {
        ...
        if (fractalDepth < 1) {
            ...
            return getDepthLocal(x, 1, index, 1);  // start recursion
        }
    }
